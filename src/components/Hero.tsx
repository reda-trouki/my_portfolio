...
export function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex flex-col justify-center items-center relative overflow-hidden pt-5 px-4 sm:px-6">
      ...
      <div className="container mx-auto py-8 md:py-28 relative z-10">
        <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
          ...
          <motion.p
            ...
            className="mt-2 sm:mt-4 text-sm sm:text-lg md:text-xl text-gray-300 max-w-2xl leading-relaxed"
          >
          ...
          <motion.div
            ...
            animate={{ opacity: isVisible ? 1 : 0, y: isVisible ? 0 : 20 }}
            transition={{ duration: 0.7, delay: 0.5 }}
            className="sm:hidden flex items-center justify-center gap-5 mt-6"
          >
            {[
              { icon: <Github className="h-5 w-5" />, href: "https://github.com/reda-trouki" },
              { icon: <Linkedin className="h-5 w-5" />, href: "https://linkedin.com/in/reda-trouki" },
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row gap-4 mt-7 sm:mt-8 w-full sm:w-auto"
          >
            <a
              href="/files/reda-trouki_en.pdf"
              className="px-6 sm:px-8 py-3 sm:py-3 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 text-white text-sm sm:text-base font-medium hover:shadow-lg hover:shadow-blue-500/25 transition-all flex items-center justify-center gap-2"
            >
            ...
            <a
              href="#contact"
              className="px-6 sm:px-8 py-3 sm:py-3 rounded-full bg-transparent border border-white/20 text-white text-sm sm:text-base hover:bg-white/10 transition-all flex items-center justify-center gap-2"
            >
          ...
          <motion.div
            ...
            className="absolute -bottom-8 md:bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center"
          >
